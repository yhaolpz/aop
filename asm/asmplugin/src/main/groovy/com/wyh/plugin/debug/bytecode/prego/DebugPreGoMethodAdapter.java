package com.wyh.plugin.debug.bytecode.prego;

import com.wyh.plugin.debug.bytecode.Parameter;
...
public class DebugPreGoMethodAdapter extends MethodVisitor implements Opcodes {
    ...
    public AnnotationVisitor visitAnnotation(String desc, boolean visible) {
        ...
        if("Lcom/wyh/asmlibrary/HunterDebug;".equals(desc) || "Lcom/wyh/asmlibrary/HunterDebugImpl;".equals(desc)) {
            needParameter = true;
        }
        return defaultAv;
    }
